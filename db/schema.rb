...
ActiveRecord::Schema.define(version: 20161225123207) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.boolean  "profile_incomplete",     default: false, null: false
    t.index ["confirmation_token"], name: "index_users_on_confirmation_token", unique: true, using: :btree
    t.index ["email"], name: "index_users_on_email", unique: true, using: :btree
    t.index ["is_public"], name: "index_users_on_is_public", using: :btree
    t.index ["profile_incomplete"], name: "index_users_on_profile_incomplete", using: :btree
